...
add_files -tb ../source/tests/gtest_main.cpp -cflags "-I../source/src -I../source/build/src -I../source/tests -I/usr/local/include/eigen3"
add_files -tb ../source/tests/test_parallel_approach.cpp -cflags "-I../source/src -I../source/build/src -I../source/tests -I/usr/local/include/eigen3"
