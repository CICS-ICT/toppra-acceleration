...
<project xmlns="com.autoesl.autopilot.project" name="toppra_hls.prj" top="SeidelParallelSolveStagewiseBatchHLS">
  <files>
    ...
    <file name="../../../source/tests/test_parallel_approach.cpp" sc="0" tb="1" cflags="-I../../../source/src -I../../../source/build/src -I../../../source/tests -I/usr/local/include/eigen3 -I/opt/openrobots/include"/>
  </files>
  <solutions>
